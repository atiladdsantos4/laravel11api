...
use Carbon\Carbon;
    ...
    class CliClientesDetaisInterface { 
        ...
        public function colunas( $d, $row) {
                ...
                $this->columns = array(
                    ...
                    array( 'db' => 'cli_type',  'dt' => 'cli_type' ),
                    array( 'db' => 'cli_name',   'dt' => 'cli_name' ),
                    array( 'db' => 'cli_cpf_cnpj', 'dt' => 'cli_cpf_cnpj' ),
                    array( 'db' => 'cli_ativo',     'dt' => 'cli_ativo' ),
                    array(
                        'db'        => 'cli_date_creation',
                        'dt'        => 'cli_date_creation',
                        'formatter' => function( $d, $row ) {
