                ...
                $this->columns = array(
                    ...
                    array(
                        ...
                        'formatter' => function( $d, $row ) {
                            ...
                            $url = route('token.listar', $d);
                            $linha .='&nbsp <a href="'.$url.'"><i data-toggle="tooltip" data-placement="top" title = "Visualizar Tokens" class="fas fa-lg fa-key grid-green pt" aria-hidden="false"></i></a>';
                            return $linha;
                        }
                    )
                );
