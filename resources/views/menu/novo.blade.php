@php
  ...
  //echo 'date-milisegundos: '.config('app.pdo_values.db_host'); 
@endphp
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">
                                <i class="fa fa-address-book" aria-hidden="true"></i>&nbsp;Criar Novo Menu
                            </h6>
                        </div>
                        <div class="card-body border-left-primary">
                            <form name="form" class="needs-validation" method="POST" action="{{route('menu.save')}}" novalidate>
                            @csrf 
                                <input type="hidden" name="men_pai">
                                <input type="hidden" name="men_filho">
                                <input type="hidden" id="men_ativo" name="men_ativo" value="1">
                                <input type="hidden" id="men_ul_id" name="men_ul_id">
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <select class="form-control"  id="men_id_esc" name="men_id_esc" required>
                                            <option selected value="">Selecione o Escopo</option>
                                            <?php foreach($escopo as $item){
                                                echo '<option value="'.$item->esc_id_esc.'">'.$item->esc_title.'</option>';
                                            }    
                                            ?>
                                        </select>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select class="form-control"  id="men_filho_pai" name="men_filho_pai" required>
                                            ...
                                            <?php foreach($menu as $item){
                                             echo '<option value="'.$item->men_id.'">'.$item->men_name.'</option>';
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control form-control-user"
                                            ...
                                            placeholder="Informe Nome do Menu..." required>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" class="form-control form-control-user"
                                            id="men_position" name="men_position" required> 
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" class="form-control form-control-user"
                                            id="men_filho_position" name="men_filho_position" required> 
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control form-control-user"
                                            ...
                                            placeholder="Informe Folder do Menu..." >
                                    ...
                                    <div class="form-group col-md-3">
                                        <div style="margin-top:33px;margin-left:18px;">
                                            ...
                                            <label style="form-check-label"Zfor="tipo_menu">&nbsp;&nbsp;Ativo</label>&nbsp;
                                    ...
                                    <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control form-control-user"
                                                ...
                                                placeholder="Informe Id de Referência..." required>
                                    ...
                                    <div class="form-group col-md-3">
                                            ...
                                            <input type="text" readonly class="form-control form-control-user"
                                                id="men_data_criacao" name="men_data_criacao" value="<?php echo $data; ?>"> 
                                    </div>
                                </div>        
                                <!-- Divider -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-2">    
                                        <a href="{{route('escopo.novo')}}" type="button" class="btn-escopo btn btn-info btn-block">
                                          <i class="fa fa-check" aria-hidden="true"></i>
                                          Criar Escopo
                                        </a>
                                    </div>
                                    <div class="form-group col-md-2">    
                                        <a href="{{route('menu.index')}}" type="button" class="btn-list btn btn-warning btn-block">
                                          <i class="fa fa-check" aria-hidden="true"></i>
                                          Listar Menus
                                        </a>
                                    </div>
...
<script>
  setTimeout(() => { 
        $('.btn-list,.btn_submit,.btn-escopo').attr("data-toggle","tooltip"); 
        $('.btn-list,.btn_submit,.btn-escopo').attr("data-placement","top");
        $(".btn-list").attr("title","Clique aqui para Listar Escopos");
        $(".btn-submit").attr("title","Clique aqui para Salvar os Dados");
        $(".btn-escopo").attr("title","Clique aqui para Criar Novo Escopo");
