...
<body class="bg-gradient-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{route('login.login')}}" novalidate>
                                    <!-- <form class="user" method="POST" action="{{route('login.api')}}" novalidate> -->     -->
                                        @csrf 
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="email" name="email" aria-describedby="emailHelp"
                                                placeholder="Informe Endereço de Email...">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <a href="{{route('index.login')}}" class="btn btn-facebook btn-user btn-block">
    ...
    <!-- Bootstrap core JavaScript - scripts_fotter_Login -->
    {{-- @include('sb.layouts.scripts_footer_login') --}}
    <!-- End Bootstrap core JavaScript - scripts_fotter_Login -->
    <!-- script botton page --> 
    {{--@include('layouts/scripts_footer.php')--}}
</body>
