        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Listagem de Usuários</p>
                    ...
                    <div class="card shadow mb-4 border-left-primary">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tb-usuario" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>Nome</th>
...
@include('sb.componentes.modal_exclui',["field_pk" => 'esc_id_esc', "rota" => route('usuario.delete')])
